 ...
 *
 * Run:  pnpm demo:paid
 * Test: curl http://localhost:3000/free    → 200 (free)
 *       curl http://localhost:3000/paid    → 402 (payment required)
 */
...
Try: <code>curl http://localhost:${PORT}/free</code><br>
Then: <code>curl -i http://localhost:${PORT}/paid</code></p>
</body></html>`);
});
